...
const dishes = {
  Signatures: [
    [
      "Prawn Ghee Roast",
      "Mangalorean spices, curry leaf, coastal ghee",
      "₹845",
    ],
    ["Crab Masala", "Whole crab, roasted coconut, tamarind", "₹1,050"],
    ["Lobster Butter Garlic", "Charred lobster, kokum butter, herbs", "₹1,450"],
    ["Clams Sukka", "Tender clams, fresh coconut, Byadgi chilli", "₹695"],
  ],
  "From the Coast": [
    ["Fish Curry", "Daily catch, raw mango, coconut milk", "₹625"],
    ["Pomfret Fry", "Ajwain, lime, crisp coastal marinade", "₹895"],
    ["Surmai Tawa Fry", "Iron tawa, pepper, garlic, curry leaf", "₹775"],
    ["Squid Fry", "Tender squid, fennel, green chilli", "₹645"],
  ],
  "The Table": [
    ["Neer Dosa", "Soft rice crepes, coconut chutney", "₹225"],
    ["Appam", "Lacy rice hoppers, palm jaggery", "₹245"],
    ["Malabar Parotta", "Layered, flaky, hand-rolled", "₹195"],
    ["Coastal Rice Bowl", "Steamed rice, pickle, seasonal sides", "₹325"],
  ],
};
...
const reviews = [
  [
    "Ananya Rao",
    "The freshest seafood and the warmest service. A true Mangalore gem.",
    "2 weeks ago",
  ],
  [
    "Rahul Menon",
    "The sunset table, the crab masala, the stories — everything felt special.",
    "1 month ago",
  ],
  [
    "Priya Shah",
    "A beautiful, soulful dining experience. We are already planning our next visit.",
    "3 months ago",
  ],
];

function LeafCorners({ dark = false }: { dark?: boolean }) {
  return (
    <>
      <Leaf
        aria-hidden="true"
        className={`corner-leaf corner-leaf-left ${dark ? "text-sand/30" : "text-palm/20"}`}
      />
      <Leaf
        aria-hidden="true"
        className={`corner-leaf corner-leaf-right ${dark ? "text-sand/30" : "text-palm/20"}`}
      />
    </>
  );
}
...
export function SeaSecret() {
  return (
    <main className="sea-secret" id="top">
      <SiteHeader />
      <section id="home" className="hero">
        ...
        <div className="hero-content">
          <p className="eyebrow light">
            <span />
            Authentic Coastal Dining in Pune
          </p>
          <h1>
            Where the
            <br />
            <em>tide</em> meets the table.
          </h1>
          <p className="hero-copy">
            Fresh seafood, authentic coastal recipes & unforgettable dining
            experiences at our JM Road and NIBM outlets.
          </p>
        ...
        <a className="scroll-cue" href="#offer">
      ...
      <section id="about-teaser" className="section story-section">
        ...
        <div className="story-grid">
          <div className="story-image-wrap">
            <img src="/gallery/a.avif" alt="Sea Secret Coastal Dining" />
            <span className="image-caption">Authentic Coastal Flavours</span>
          </div>
          ...
          <div className="story-copy">
            ...
            <p>
              From our first outlet on JM Road in 2019 to our expansion at NIBM
              in 2021, our journey has always been driven by one passion—serving
              exceptional seafood with authentic flavours, quality ingredients,
              and heartfelt service that keeps our guests coming back.
            </p>
          ...
          <div className="event-grid">
            ...
            <article className="event-card event-card-crab">
              ...
              <div className="event-card-body">
                ...
                <p>
                  Dive into an unforgettable crab & prawn experience featuring
                  fresh mud crabs, chef specials, live grilling, and exclusive
                  seafood platters for every crab lover.
                </p>
      ...
      <section className="founders-section section">
        <div className="founders-heading">
          ...
          <p className="section-copy">
            ...
            authentic coastal cuisine have made Sea Secret one of Pune's
            favourite seafood destinations.
          </p>
        </div>
        ...
        <div className="founder-grid">
          <article className="founder-card">
            ...
            <div>
              ...
              <h3>Roney George</h3>
              <p>
                "Our goal has always been simple — serve authentic coastal food
      ...
      <section className="reviews-section section">
        <SectionIntro
          eyebrow="Loved by the coast"
          title="Good food travels."
          copy="A few words from guests who have found their way to our table."
        />
        <div className="review-grid">
          {reviews.map(([name, copy, date]) => (
            <article className="review-card" key={name}>
              ...
              <footer>
                <strong>{name}</strong>
                <small>{date} · Google Review</small>
              </footer>
            </article>
          ))}
        </div>
      ...
      <section className="testimonial-section section">
        <SectionIntro
          ...
          title="Guest Stories."
          copy="Watch our guests share their Sea Secret experience."
        />
